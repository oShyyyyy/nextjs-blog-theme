        ...
        function window:Watermark(info)
            ...
            utility:Connection(rs.RenderStepped, function(FPS)
                ...
                if (tick() - Tick) > 0.15 then
                    watermark_title.Text = string.format("🤓 🤓🤓| Ping : %s | Fps : %u", library.shared.ping, library.shared.fps)
                    window.watermark:UpdateSize()
                    --
                    Tick = tick()
                end
...
--[[
 ...
 The section shits, home start here niggas

 down is the start
--]]
local window = library:New({name = "Nerds inc \ Private"})
     ...
     local Menu_colors = settings_page:Section({name = "UI"})
       menu_section:Keybind({pointer = "settings_bind", name = "Bind", default = Enum.KeyCode.RightShift, callback = function(boolean)
         ...
         Menu_colors:Button({name = "Select", callback = function()
                  if library.pointers["settings_selectedtheme"]:get() == "Neko" then
 ...
 elseif library.pointers["settings_selectedtheme"]:get() == "BubbleGum" then
                      library:UpdateColor("Accent", Color3.fromRGB(169, 83, 245))
                        ...
                        library:UpdateColor("inline", Color3.fromRGB(46, 46, 46))
                                            elseif library.pointers["settings_selectedtheme"]:get() == "AimWare" then
                        ...
                        library:UpdateColor("outline", Color3.fromRGB(0, 0, 0))
                        library:UpdateColor("inline", Color3.fromRGB(46, 46, 46))
                    elseif library.pointers["settings_selectedtheme"]:get() == "np.rip" then
                        library:UpdateColor("Accent", Color3.fromRGB(242, 150, 92))
                        library:UpdateColor("lightcontrast", Color3.fromRGB(22, 12, 46))
                        library:UpdateColor("darkcontrast", Color3.fromRGB(17, 8, 31))
                        library:UpdateColor("outline", Color3.fromRGB(0, 0, 0))
                        library:UpdateColor("inline", Color3.fromRGB(46, 46, 46))
                    elseif library.pointers["settings_selectedtheme"]:get() == "Abyss" then
                    ...
                    elseif library.pointers["settings_selectedtheme"]:get() == "Slime" then
            ...
            elseif library.pointers["settings_selectedtheme"]:get() == "Default" then 
              ...
              library:UpdateColor("darkcontrast", pointers["settings_darkcontrast"]:get())
                library:UpdateColor("inline", pointers["settings_inline"]:get())                
                library:UpdateColor("outline", pointers["settings_outline"]:get())
                elseif library.pointers["settings_selectedtheme"]:get() == "plaguecheat" then 
          ...
          elseif library.pointers["settings_selectedtheme"]:get() == "Neverlose" then 
          ...
          elseif library.pointers["settings_selectedtheme"]:get() == "Dracula" then 
              ...
              library:UpdateColor("Accent", Color3.fromHex("8262a5"))
                library:UpdateColor("inline", pointers["settings_inline"]:get())                
                library:UpdateColor("outline", pointers["settings_outline"]:get())
                 elseif library.pointers["settings_selectedtheme"]:get() == "Dracula blue" then 
              ...
              library:UpdateColor("Accent", Color3.fromHex("6271a5"))
                library:UpdateColor("inline", pointers["settings_inline"]:get())                
                library:UpdateColor("outline", pointers["settings_outline"]:get())
          elseif library.pointers["settings_selectedtheme"]:get() == "BBot" then 
          ...
          elseif library.pointers["settings_selectedtheme"]:get() == "Spotify" then 
              library:UpdateColor("lightcontrast", Color3.fromRGB(18,18,18))
              library:UpdateColor("Accent", Color3.new(0.0993174,0.90584,0.278489))                
              library:UpdateColor("darkcontrast", Color3.fromRGB(25, 25, 25))
                library:UpdateColor("inline", library.pointers["settings_inline"]:get())                
                library:UpdateColor("outline", library.pointers["settings_outline"]:get())
          elseif library.pointers["settings_selectedtheme"]:get() == "Gamesense" then 
              library:UpdateColor("lightcontrast", Color3.fromRGB(18,18,18))
              library:UpdateColor("Accent", Color3.fromRGB(147,184,26))    
              library:UpdateColor("darkcontrast", Color3.fromRGB(25, 25, 25))
                library:UpdateColor("inline", library.pointers["settings_inline"]:get())                
                library:UpdateColor("outline", pointers["settings_outline"]:get())
          elseif library.pointers["settings_selectedtheme"]:get() == "Twitch" then 
              ...
              library:UpdateColor("darkcontrast", Color3.fromRGB(17,17,17))
                library:UpdateColor("inline", pointers["settings_inline"]:get())                
                library:UpdateColor("outline", pointers["settings_outline"]:get())
          elseif library.pointers["settings_selectedtheme"]:get() == "Tokyo Night" then 
              ...
              library:UpdateColor("darkcontrast", Color3.fromRGB(22,22,31))
                library:UpdateColor("inline", pointers["settings_inline"]:get())                
                library:UpdateColor("outline", pointers["settings_outline"]:get())
              elseif library.pointers["settings_selectedtheme"]:get() == "Fatality" then 
         ...
         Menu_colors:Colorpicker({pointer = "settings_textcolor", name = "text color", default = Color3.fromRGB(255, 255, 255), callback = function(Color)
          ...
          Menu_colors:Textbox({pointer = "settings_cfadagname", placeholder = "Test", text = "niga", middle = true, reset_on_focus = false, callback = function(Coloaar)
              print(Coloaar)
              end})
